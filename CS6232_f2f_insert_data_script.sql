...
INSERT [dbo].[PersonalDetails] ([pdID], [firstName], [lastName], [dateOfBirth], [gender], [streetAddress], [city], [state], [zipCode], [country], [phoneNumber]) VALUES (6, 'Hailey', 'Jr', '11-5-1991', 'Female', '2-Up Mountain Parkway', 'Orlando', 'Florida', '30329', 'United States', '3216549874')
...
INSERT [dbo].[Appointment] ([appointmentID], [doctorID], [patientID], [scheduledDate], [reason]) VALUES (1, 1, 2, '2023-04-14', 'Mild Surgery for the body')
INSERT [dbo].[Appointment] ([appointmentID], [doctorID], [patientID], [scheduledDate], [reason]) VALUES (2, 2, 1, '2023-04-13', 'General health check up')
...
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (3, 'Blood Plateletes Count Tests')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (4, 'Genetic Testing')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (5, 'Kidney Tests')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (6, 'CT Scan')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (7, 'Prenatal Testing')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (8, 'Thyroid Tests')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (9, 'Urinalysis')
INSERT [dbo].[Tests] ([testID], [testName]) VALUES (10, 'MRI')
...
INSERT [dbo].[Visit] ([visitID], [appointmentID], [nurseID], [height], [weight], [systolicBP], [diastolicBP], [bodyTemperature], [pulse], [symptoms], [initialDiagnosis]) VALUES (1, 1, 1, 5.10, 180.25, 120, 80, 98.4, 85, 'Mild Headache', 'Body temperature is normal. Need to get an X-Ray done.')
